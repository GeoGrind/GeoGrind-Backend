...
class RabbitMQHelperImpl(
    private val rabbitMQConfigImpl: RabbitMQConfig
) : RabbitMQHelper {
    override suspend fun sendSessionDeletionMessage(sessionToDelete: Sessions) {
        try {
            ...
            val message = "Session with session id: ${sessionToDelete.sessionId} has been stopped!".toByteArray(StandardCharsets.UTF_8)
